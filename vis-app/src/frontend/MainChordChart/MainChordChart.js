...
const MainChordChart = (props) => {
  ...
  useEffect(async () => {
    ...
    // console.log("before", chord_data.groups);
    if (film === "Feature Films") {
      chord_data = chord(featured_matrix);
      // console.log("after", chord_data.groups);
    } else if (film === "OTT Films") {
      chord_data = chord(OTT_matrix);
    }
  ...
  return (
    <div className="d-flex flex-column justify-content-center">
      ...
      <div className="d-flex justify-content-center chord-chart p-0">
